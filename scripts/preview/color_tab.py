...
from .ui_tabs import (
    load_colors_from_yaml, load_yaml_file, _get_cached_yaml_data, _set_cached_yaml_data,
    resolve_color_reference, resolve_palette_reference, create_small_color_swatch
)
...
class ColorTab(QWidget):
    ...
    def update_colors(self):
        ...
        try:
            ...
            if not mappings:
                ...
                mappings_file = (
                    current_dir / "src" / "themeweaver" / "themes" / 
                    current_theme / "mappings.yaml"
                )
    ...
    def _update_semantic_mappings(self, colors, mappings, variant):
        ...
        if semantic_mappings and variant in semantic_mappings:
            mapping_widget = self._create_semantic_mapping_widget(colors, mappings, variant)
    ...
    def _create_color_swatch(self, color_name, color_value):
        ...
        name_label.setStyleSheet("font-size: 7px; font-weight: bold; background-color: transparent;")
        ...
        if not semantic_mappings:
            ...
            categories = {
                ...
                "Success/Error/Warning": [
                    k for k in semantic_mappings.keys() 
                ...
                "Other": [
                    ...
                    if not any(x in k for x in [
                        "BACKGROUND", "TEXT", "ACCENT", "SUCCESS", "ERROR", "WARN",
                        "ICON", "GROUP", "HIGHLIGHT", "OCCURRENCE", "LOGO"
                    ])
                ],
            }
